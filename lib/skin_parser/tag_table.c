...
#define TAG(type,name,param,flag) {(type),sizeof(name),(name "\0" param),(flag)}
    ...
    TAG(SKIN_TOKEN_TRIMPOD_LEGEND,        "Tl", "", SKIN_REFRESH_DYNAMIC),
    ...
    TAG(SKIN_TOKEN_SPECTRUM,              "pm", "", SKIN_REFRESH_SPECTRUM),
    ...
    TAG(SKIN_TOKEN_VOLUME_MIN,            "vn" , "", SKIN_REFRESH_STATIC),
    TAG(SKIN_TOKEN_VOLUME_LIMIT,          "vx" , "", SKIN_REFRESH_DYNAMIC),
    TAG(SKIN_TOKEN_VOLUME_NOTCH,          "vv" , "", SKIN_REFRESH_DYNAMIC),
